...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # Final_outputs is exactly same as final_inputs because the output
        # node is just passing the value through
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y,\
        ...
        output_error_term = error # because error gradient f'(x)=1

        # Note the rest of this method assumes there is only one output node
        # and that X is a sample, i.e. not the full batch used in learning.
